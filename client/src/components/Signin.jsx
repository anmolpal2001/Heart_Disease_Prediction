    ...
    <div className="flex justify-center items-center mt-20">
      <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
          ...
          <form onSubmit={submitHandler}>
            ...
            <div className="flex items-center mb-6 -mt-4">
              <div className="flex ml-auto">
                <a
                  href="#"
                  className="inline-flex text-xs font-light text-blue-400 sm:text-sm dark:text-gray-100 hover:text-gray-700 dark:hover:text-white"
                >
        ...
        <div className="flex items-center justify-center mt-6 ">
          ...
          >
            <span className="ml-2 text-gray-600">You don&#x27;t have an account? <span className=" text-blue-500 hover:text-gray-700">Sign Up</span></span>
          </Link>
        </div>
      </div>
    </div>
